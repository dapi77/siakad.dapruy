    ...
    <div class="row">
        ...
        <main role="main" class="col-md-10 ml-sm-auto px-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2 text-gray-800">Manajemen Data Kelas (Dummy)</h1>
...
<script>
    // Data Dummy Awal
    let dataKelas = [
        { nama: "X PPLG 1", wali: "Bpk. Budi Santoso" },
        { nama: "XI PPLG 1", wali: "Ibu Siti Aminah" }
    ];
    ...
    function editData(index) {
        ...
        document.getElementById('namaKelas').value = dataKelas[index].nama;
        document.getElementById('waliKelas').value = dataKelas[index].wali;
        $('#kelasModal').modal('show');
    }
